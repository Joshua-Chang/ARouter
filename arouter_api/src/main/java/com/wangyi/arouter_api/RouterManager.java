...
public class RouterManager {
    ...
    Object navigation(@NonNull Context context, BundleManager bundleManager, int code) {
        ...
        String groupClassName = "com.netease.modular.apt" + GROUP_FILE_PREFIX_NAME + group;
...
//                            A跳B，B在返回，A先navigation，B在navigation且withResultString
                            // startActivityForResult -> setResult
                            if (bundleManager.isResult()) {//此处是给B点击时调用
